import 'package:dln/api/dln_api.dart';
...
void main() {
  var connection = DlnApi(entrypoint: Entrypoint.dln);
  ...
  test('request order create tx', () async {
    var route = await connection.getOrderCreationTransaction(
        ...
        srcChainOrderAuthorityAddress:
            "4aMdEiKLkXMz1F87Q69axNQdwRCna18MjSjAxGBetsn3",
        dstChainOrderAuthorityAddress:
            "0x4A4CE6586B7E702E0C52B8B3A6c7261463801d98",
        srcChainTokenIn: "EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v",
  ...
  test("get order status", () async {
    var status = await connection.getOrderStatus(
        txHash:
            "2pfKYrJFmnG4mLsq96N6nrqQT8S3ixhb4Yuotaf2KUQU24kPz8HeoHuzMa3R3jeKKHCrux4XYGAnwFGG7wy5FJxx");
    debugPrint(status);
  });

  test("cancel order", () async {
    var status = await connection.cancelOrder(
        txHash:
            "2pfKYrJFmnG4mLsq96N6nrqQT8S3ixhb4Yuotaf2KUQU24kPz8HeoHuzMa3R3jeKKHCrux4XYGAnwFGG7wy5FJxx");
